...
lesson(29, 'boot', 'Loading a program and choosing a boot state', 'src/Gba.Core/Cartridge/BootSession.cs',
    ...
    ['Connect a byte image to RomImage and guest ROM address windows; preserve ROM as read-only input.', 'Define a synthetic boot fixture with explicit PC, SP, mode, instruction state, RAM, and expected final signature.', 'Run a supplied/owned BIOS or a clearly scoped alternative, then diagnose the first divergence for a selected diagnostic or game.'],
